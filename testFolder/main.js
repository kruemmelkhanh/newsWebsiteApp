...
let url =
  "https://newsapi.org/v2/top-headlines?sources=die-zeit&apiKey=c90d69bab6e84e39ac36904e19c7fbdd";
...
const getNews = async function(url) {
  ...
  let miniRow = document.getElementById("miniRow");
  ...
  if (data.status === "ok") {
    ...
    let summaries = data.articles.map(function(item) {
      ...
      <div class="d-flex w-100 justify-content-between">
        <strong><h5 class="mb-1">${item.title}</h5></strong>
    ...
    let headlines = data.articles.map(function(item) {
      ...
      return (item = `<div class="col-md-4">
